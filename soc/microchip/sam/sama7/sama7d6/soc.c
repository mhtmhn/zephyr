...
static const struct arm_mmu_region mmu_regions[] = {
	...
	MMU_REGION_FLAT_ENTRY("lcdc", LCDC_BASE_ADDRESS, 0x4000,
				  MT_STRONGLY_ORDERED | MPERM_R | MPERM_W),

	MMU_REGION_FLAT_ENTRY("dsi", DSI_BASE_ADDRESS, 0x4000,
			      MT_STRONGLY_ORDERED | MPERM_R | MPERM_W),

	MMU_REGION_FLAT_ENTRY("lvdsc", LVDSC_BASE_ADDRESS, 0x4000,
			      MT_STRONGLY_ORDERED | MPERM_R | MPERM_W),

	MMU_REGION_FLAT_ENTRY("gpu2dc", GPU2DC_BASE_ADDRESS, 0x1000,
			      MT_STRONGLY_ORDERED | MPERM_R | MPERM_W),
